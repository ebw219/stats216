...
// Import Google's JSON library
  ...
  */
 public class App {
	public static GsonFactory factory = new GsonFactory();
	public static UrlFetchTransport transport = new UrlFetchTransport();
     /**                                                                                                                                                                    
	  ...
	  **/
	  ...
	  JsonFactory jsonFactory = JacksonFactory.getDefaultInstance();
		 String REDIRECT_URI = "https://lyle-buzz.herokuapp.com";
		 String CLIENT_SECRET_FILE = "/path/to/client_secret.json";
	  // Exchange auth code for access token
	  GoogleClientSecrets clientSecrets =
	     GoogleClientSecrets.load(com.google.api.client.json.JsonFactory.getDefaultInstance(), new FileReader(CLIENT_SECRET_FILE));
	  GoogleTokenResponse tokenResponse =
		 ...
		 idToken,
		 REDIRECT_URI)  // Specify the same redirect URI that you use with your web app. 
